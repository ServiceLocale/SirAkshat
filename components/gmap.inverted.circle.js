...
InvertedCircle = function(opts) {
  options = {
    ...
    stroke_weight: 1,
    point_visible: false,
    posChangeCallback: function() {},
    radiusChangeCallback: function() {},
    fill_opacity: 0.3,
    fill_color: "#000",
  ...
  options.draggable = options.editable;
  options.point_visible = options.editable;
  ...
  this.set('posChangeCallback', options.posChangeCallback);
  this.set('radiusChangeCallback', options.radiusChangeCallback);


  // TODO: We should be able to set custom center marker image icon
  var center_marker = new google.maps.Marker({
    visible: options.point_visible
  });

  google.maps.event.addListener(center_marker, 'dragend', function() 
  {
      options.posChangeCallback(center_marker.getPosition());
  });
...
InvertedCircle.prototype.addSizer_ = function() {
  ...
  google.maps.event.addListener(sizer_left, 'dragend', function() {
    ...
    me.get('radiusChangeCallback')(radius);
    me.setRadius(radius);
